                ...
                case svr_to_client.svr_msg_id.status_code_ntf_id:
                    ...
                    switch (ret) {
                        ...
                        case svr_to_client.status_code.pwd_is_wrong:
                            managers.WindowManager.getInstance().showTip(lang.Lang.Get(lang.LangID.Error_Login_Pwd));
                            managers.EventManager.getInstance().event(core.EventType.S2C_Login_Fail);
                            break;
                        case svr_to_client.status_code.invaild_user:
                            managers.WindowManager.getInstance().showTip(lang.Lang.Get(lang.LangID.Error_Login_Name));
                            managers.EventManager.getInstance().event(core.EventType.S2C_Login_Fail);
                            break;
