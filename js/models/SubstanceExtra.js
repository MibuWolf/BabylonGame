    ...
    class SubstanceExtra extends models.Model {
        ...
        get updateTexture() {
            ...
            this._textures.forEach((value, key) => {
                texInfo.texPaths.set(key, GameConfig.Substance_Static_Model_URL + "/" + this.id + "/" + this.version + "/" + value);
            });
        ...
        get meshList() {
            ...
            meshInfo.meshName = GameConfig.Substance_Static_Model_URL + "/" + this._meshName;
