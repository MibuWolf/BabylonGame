            ...
            mouseHandler(evt) {
                switch (evt.target) {
                    ...
                    case this.btn_favorite:
                        // proxy.HttpProxy.req_fork_res("private", managers.LoginManager.inst.account.getId(), this._data.directory, this._data.group,
                        // 	"", "", models.Directory.PERSONALITY, models.ResGroup.MY_FAVORITE, this._data.id);
                        break;
                }
            }
