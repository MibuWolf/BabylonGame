        ...
        class MainView extends ui.views.MainViewUI {
                ...
                switch (this.cbx_view.selectedLabel) {
                    case MainView.D2:
                        ...
                        if (!this._preview2DView) {
                            ...
                            this._preview2DView.x = this._resView.x + this._resView.width + 5;
                            this._preview2DView.y = this._resView.y;
                            this.addChild(this._preview2DView);
                        }
                        this._preview2DView.visible = true;
                        break;
                    case MainView.D3:
                        ...
                        if (!this._preview3DView) {
                            ...
                            this._preview3DView.x = this._resView.x + this._resView.width;
                            this._preview3DView.y = this._resView.y;
                            this.addChild(this._preview3DView);
                            this._preview3DView.addBabylonView(Laya.stage.width - this._preview3DView.x - 10, Laya.stage.height - this._preview3DView.y - this._editorView.height - 20);
            ...
            selectResItemHandler(index) {
                ...
                if (this.cbx_view.selectedLabel == MainView.D2 && this._preview2DView) {
                    ...
                    this._preview2DView.size(Laya.stage.width - this._preview2DView.x - 10, Laya.stage.height - this._preview2DView.y - this._editorView.height - 20);
                }
                    ...
                    this._preview3DView.size(Laya.stage.width - this._preview3DView.x - 10, Laya.stage.height - this._preview3DView.y - this._editorView.height - 20);
                }
            ...
            onResize() {
                ...
                if (this._preview2DView) {
                    this._preview2DView.x = this._resView.x + this._resView.width + 10;
                    this._preview2DView.y = this._resView.y;
                    this._preview2DView.size(Laya.stage.width - this._preview2DView.x - 10, Laya.stage.height - this._preview2DView.y - this._editorView.height - 10);
                }
                if (this._preview3DView) {
                    this._preview3DView.x = this._resView.x + this._resView.width + 10;
                    this._preview3DView.y = this._resView.y;
                    this._preview3DView.size(Laya.stage.width - this._preview3DView.x - 10, Laya.stage.height - this._preview3DView.y - this._editorView.height - 10);
                }
